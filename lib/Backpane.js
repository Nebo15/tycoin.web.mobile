var Backpane = (function() {
  ...
  function setBackpaneTransformValue(value) {
    if(value === 0 || value === getBackpaneWidth()) {
      $('.content, .bar-title, .bar-tab').css("-webkit-transition", "-webkit-transform 0.3s linear");
      $('.content, .bar-title, .bar-tab').css("transition", "transform 0.3s linear");
    } else {
